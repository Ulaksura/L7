...
public class MainFrame extends JFrame {
    ...
    ArrayList<Socket> list = new ArrayList<>(10); // максы 10
...
/*
        ...
        Action addBallAction = new AbstractAction("Список Пользователей") {
            public void actionPerformed(ActionEvent event) {
                Reader(list);
            }
        };
        menuBar.add(UserMenu);
        UserMenu.add(addBallAction);
*/
...
// Выводим сообщение в текстовую область
                        textAreaIncoming.append(  senderName +" (" + address + "): " +
                                message + "\n");
                    }
                } catch (IOException e) {
                    e.printStackTrace();
